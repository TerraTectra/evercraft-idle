...
- Default speed multiplier in this fork: `x20`.
...
```js
window.evercraftSpeed.setMultiplier(20);
```
...
If speed is not noticeable, force x20 and reload:

```js
localStorage.setItem("evercraft-speed-multiplier", "20");
location.reload();
```
